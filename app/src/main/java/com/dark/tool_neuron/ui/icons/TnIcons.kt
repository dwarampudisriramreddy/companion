...
object TnIcons {
    ...
    val Vault by lazy { tabler("M12 3c4.418 0 8 2.239 8 5s-3.582 5 -8 5s-8 -2.239 -8 -5s3.582 -5 8 -5", "M4 8v10c0 2.761 3.582 5 8 5s8 -2.239 8 -5v-10", "M12 13c4.418 0 8 2.239 8 5s-3.582 5 -8 5s-8 -2.239 -8 -5s3.582 -5 8 -5") }
